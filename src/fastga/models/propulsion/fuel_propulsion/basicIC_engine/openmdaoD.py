...
from fastga.models.propulsion.fuel_propulsion.basicIC_engine.basicIC_engineD import BasicICEngineD
from fastga.models.propulsion.fuel_propulsion.base import FuelEngineSet
from fastga.models.aerodynamics.components.compute_propeller_aero import THRUST_PTS_NB, SPEED_PTS_NB


@oad.RegisterPropulsion("fastga.wrapper.propulsion.basicIC_engineD")
class OMBasicICEngineWrapper(oad.IOMPropulsionWrapper):
    ...
    def get_model(inputs) -> IPropulsion:
        ...
        return FuelEngineSet(
            BasicICEngineD(**engine_params), inputs["data:geometry:propulsion:engine:count"]
        )
