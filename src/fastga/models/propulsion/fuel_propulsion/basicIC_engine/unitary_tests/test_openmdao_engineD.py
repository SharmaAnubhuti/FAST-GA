...
from fastga.models.propulsion.fuel_propulsion.basicIC_engine.openmdaoD import OMBasicICEngineComponent
...
def test_OMBasicICEngineComponent():
    ...
    thrusts = [3193.97963124,  322.29868685,  322.29868685,   66.22185406,  137.43945161]
    phases = [
    ...
    expected_sfc = [2.27738371e-06, 2.25688701e-05, 2.25688701e-05, 3.39348580e-05, 4.15706127e-05]

    ivc = om.IndepVarComp()
    ivc.add_output("data:propulsion:IC_engine:max_power", 99000, units="W")
    ivc.add_output("data:propulsion:fuel_type", 2)
    ivc.add_output("data:propulsion:IC_engine:strokes_nb", 4)
    ivc.add_output("data:TLAR:v_cruise", 130.0, units="kn")
    ...
    #print("sfc are:", problem["data:propulsion:SFC"])
    #print("thrust are:", problem["data:propulsion:thrust"])
